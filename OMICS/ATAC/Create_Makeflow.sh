...
MEMORY=20000
DISK=10
${DEEPTpre}.heatmap.gz ${DEEPTpre}.Heatmap1sortedRegions.bed : $BAMfilter
    $WORKFLOW_DIR/DEEPTstate $INp $BAMfilter
...
${MACS2cppre}_peaks.narrowPeak ${MACS2cppre}_summits.bed : $BAMfilter
    $WORKFLOW_DIR/MACS2_CallPeak  $INp  $BAMfilter
...
MEMORY=20000
DISK=10
${GENRICHpre}_genrich.peaks.narrowPeak : $BAMfilter
    $WORKFLOW_DIR/GENRICH_CallPeak $INp $BAMfilter
